...
import {
    ParamDomainBuilder
} from "../dom-service/builder/param-domain/param-domain.builder";
...
export class BuildParamDomainAppService {
    constructor(private readonly paramDomainDirector: ParamDomainDirector) {
    }
...
// import {singleton} from "tsyringe";
// import {BuildParamDomainService} from "../dom-service/builder/param-domain/param-domain.builder";
// import {ValidationParamDomainService} from "../dom-service/validation/validation-param-domain.service";
// import {type BaseGetParamDepModel, type EnumModel, type KeyValueModel} from "@lib/model";
//
// @singleton()
// /**
//  * The app service is responsible for building
