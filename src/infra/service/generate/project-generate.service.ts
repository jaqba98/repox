...
// import { ConfigProjectModel } from "../../../model/config/config-project.model";
...
//     this.execCommand.cd("../../");
//     const repoxJson = this.readFile.readJsonFile<ConfigProjectModel>("repox.json");
//     this.writeFile.writeJsonFile<ConfigProjectModel>("repox.json", {
